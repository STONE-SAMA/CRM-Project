    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#exportActivityXzBtn").click(function (){
                ...
                ids = ids.substr(0,ids.length-1);
                // alert(ids)
                window.location.href="workbench/activity/exportPartActivities.do" + ids;
            });
            ...
            $("#importActivityBtn").click(function () {
                ...
                $.ajax({
                    ...
                    data:formData,
                    processData:false,//设置ajax向后台提交参数之前，是否将参数统一转为字符串
                    contentType:false,//设置ajax向后台提交参数之前，是否将参数同于按urlencoded编码
                    type:'post',
                    dataType:'json',
                    success:function (data) {
                        if(data.code=="1"){
